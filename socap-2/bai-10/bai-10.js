import { vocabList } from "./data/vocab-bai-10.js";
import { kanjiList } from "./data/kanji-bai-10.js";
import { grammarBai3 } from "./data/grammar-bai-10.js";
import { listeningData } from "./data/listen-bai-10.js";
import { readingData } from "./data/reading-bai-10.js";
...
function renderGrammar(id) {
  ...
  cardEl.innerHTML = `
    ...
    <div class="grammar-block block-usage">
      <h4>Cách dùng</h4>
      <ul>${g.usage.map(u => `<li>${addHira(highlight(u))}</li>`).join("")}</ul>
    </div>` : ""}

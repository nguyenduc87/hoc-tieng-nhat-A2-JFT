...
import { grammarBai2 } from "./data/grammar-bai-2.js";
import { listeningData } from "./data/listen-bai-2.js";
import { readingData } from "./data/reading-bai-2.js";
...
function renderReading() {
  readingList.innerHTML = readingData.map(item => `
    <div class="reading-card">
        ...
        <div class="reading-text hidden">
            ${item.conversation.map(line => `<p>${line}</p>`).join("")}
        </div>

        <div class="reading-translate-toggle hidden">
